...
public class WinRaidSerializer extends CriterionSerializer<PositionTrigger.Instance> {
    ...
    public PositionTrigger.Instance read(PacketBuffer buffer) {
        ...
        return new PositionTrigger.Instance(VanillaCriteriaIds.WIN_RAID, EntityPredicate.AndPredicate.ANY_AND, location);
    }
}
