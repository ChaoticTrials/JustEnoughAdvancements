...
public class AlfRepairInfo implements ICriterionInfo<AlfRepairTrigger.Instance> {
    ...
    public void setIngredients(IAdvancementInfo advancement, String criterionKey, AlfRepairTrigger.Instance instance, IIngredients ii) {
        ii.setInputLists(VanillaTypes.ITEM, ImmutableList.of(
                ImmutableList.of(new ItemStack(ModBlocks.alfsteelPylon)),
    ...
    @Override
    public void draw(MatrixStack matrixStack, IRenderTypeBuffer buffer, Minecraft mc, IAdvancementInfo advancement, String criterionKey, AlfRepairTrigger.Instance instance, double mouseX, double mouseY) {
        
    }

    @Override
    public void addTooltip(List<ITextComponent> tooltip, IAdvancementInfo advancement, String criterionKey, AlfRepairTrigger.Instance instance, double mouseX, double mouseY) {
